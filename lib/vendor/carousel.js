...
(function() {
    ...
    Mistify.prototype.appendArrows = function() {
        ...
        var arrowsDom = '' +
           // '<div class="mistify__arrows">' +
            '<a href="#" class="mistify__arrows--prev"><img src="assets/arrow-left.png"></a>' +
            '<a href="#" class="mistify__arrows--next"><img src="assets/arrow-right.png"></a>'; //+
           // '</div>';
    ...
    Mistify.prototype.appendMasks = function() {
        ...
        var maskDom = '' +
            ...
            '<div class="mistify__mask mistify__mask--active"><img src="assets/mistCarousel-1.png" alt="Mask"/></div>' +
            '<div class="mistify__mask"><img src="assets/mistCarousel-2.png" alt="Mask"/></div>' +
            '<div class="mistify__mask"><img src="assets/mistCarousel-3.png" alt="Mask"/></div>' +
            '<div class="mistify__mask"><img src="assets/mistCarousel-4.png" alt="Mask"/></div>' +
            '</div>';
    ...
    Mistify.prototype.preloadMasks = function() {
        ...
        var masks = ['/assets/mistCarousel-1.png', '/assets/mistCarousel-2.png', '/assets/mistCarousel-3.png', '/assets/mistCarousel-4.png']
